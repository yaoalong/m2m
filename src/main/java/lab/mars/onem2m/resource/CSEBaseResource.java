...
import lab.mars.m2m.model.m2m_ID;
import lab.mars.m2m.model.m2m_operation;
import lab.mars.m2m.model.m2m_req;
import lab.mars.m2m.model.m2m_rsp;
...
public class CSEBaseResource implements  M2mResource
{
    ...
    public void processRequest(NetworkEvent<FullHttpRequest> m) {
        ...
        Object value=req.pc.value;
        byte[] result= ResourceReflection.serializeKryo(value);
        switch (op){
            case Create:
                try {
