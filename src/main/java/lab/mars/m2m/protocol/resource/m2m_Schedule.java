...
@XmlRootElement(name = "schedule", namespace = "http://www.onem2m.org/xml/protocols")
public class m2m_Schedule extends m2m_announceableResource implements HasChildren {
